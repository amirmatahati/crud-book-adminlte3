...
<script type="text/javascript">
    ...
    $(document).on('click', '.status', function(){
        ...
        $.ajax({
                ...
                data: { id: id,value:value, _token: '<?php echo e(csrf_token()); ?>' },
                type: 'post',
                dataType: "json",
	...
	function CreatTran() {
		...
		$('#btn-save').hide();
		$('.modal-body').load("<?php echo e(route('transactionForm')); ?>", function(){
            $('#CreatBooks').modal(
	...
	function EditTrans(id) {
		...
		$('#btn-cancel').html("Close");
		$('#btn-save').hide();
		$('.modal-body').load("<?php echo e(url('borrowing-books-update/edit')); ?>/"+id, function(){
            $('#CreatBooks').modal(
                $("#role-table").busyLoad("hide", {
                    spinner: "accordion",
                    color: "red",
    ...
    $(document).on('click','.delete_all',function(){
        ...
        if(allVals.length <=0){
            ...
            if (!isConfirm) return;
            $.ajax({
                url: '<?php echo e(route("destroytransarray")); ?>',
                data: { id: join_selected_values, _token: '<?php echo e(csrf_token()); ?>' },
                type: 'post',
                dataType: "json",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/crud-book/resources/views/transaction/index.blade.php ENDPATH**/ ?>