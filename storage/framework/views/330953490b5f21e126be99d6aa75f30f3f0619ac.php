...
<script type="text/javascript">
	...
	function CreateBooks() {
		...
		$('#btn-save').hide();
		$('.modal-body').load("<?php echo e(route('create')); ?>", function(){
            $('#CreatBooks').modal(
	...
	function EditBooks(id) {
		...
		$('#btn-cancel').html("Close");
		$('#btn-save').hide();
		$('.modal-body').load("<?php echo e(url('edit-books')); ?>/"+id, function(){
            $('#CreatBooks').modal(
                $("#role-table").busyLoad("hide", {
                    spinner: "accordion",
                    color: "red",
    ...
    $(document).on('click','.delete_all',function(){
        ...
        if(allVals.length <=0){
            ...
            if (!isConfirm) return;
            $.ajax({
                url: '<?php echo e(route("deletearraybooks")); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/crud-book/resources/views/books/index.blade.php ENDPATH**/ ?>